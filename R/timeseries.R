...
timeseries <- function (data, time, tax.aggregate="Phylum", tax.add=NULL, tax.class=NULL, tax.empty ="best") {
  ...
  ##Dividing data to seperate df
  ### This will be easier to read further on.
  abund <- data[["abund"]]  
  tax <- data[["tax"]]
  sample <- data[["sample"]]
  ...
  #Adding time variables to abundance reads and melting
